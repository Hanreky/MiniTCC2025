...
public class ifrmClientes extends javax.swing.JInternalFrame {
    ...
    public ifrmClientes() {
        ...
        // TODO: Validar campos, validar se cpf já existe e se pesquisar por cpf estiver vazio falar.
    }
    ...
    private void txtCpfFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtCpfFocusLost
        if (txtCpf.getText().trim().isEmpty()) {
            ...
            ConClientes conCli = new ConClientes();

            if (conCli.verificarCpf(txtCpf.getText().trim())) {
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
        ...
        if (!txtCpf.getText().trim().isEmpty()) {
            ...
            JOptionPane.showMessageDialog(null, "Digite um cpf!", "Aviso", JOptionPane.WARNING_MESSAGE);
        }
